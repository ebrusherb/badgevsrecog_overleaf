...
%\cite{Seyfarth:2005ve,Bergman:2003qf} ref on important of knowledge of dominance relationships
%\cite{Seyfarth:2010bh} at end of first sentence
...
% birds reviewed in \cite{Santos:2011ly,Senar:2006dq}
%take out all the specific examples, Santos and Senar reviews cover it pretty well
% UV signals: Blue Tits in Remy et al 2010 (http://link.springer.com/article/10.1007/s00265-010-0995-z)
% the extent of the black throat in Harris sparrows is correlated with dominance \cite{Rohwer:1975fk}
% odour in cockroaches \cite{Moore:1997kx}
...
%should add refs about how living in large groups is expected to improve cognition \ref{
%\cite{Briscoe:2011nx,Domingos:2000cr} for bias-variance tradeoff
