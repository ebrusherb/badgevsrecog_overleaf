...
%%%%%%%%%%%%%%%%%%%%%%%
\section*{Abstract (still need to re-write to match new draft)}
%%%%%%%%%%%%%%%%%%%%%%%
...
% role of inference in each system?
% In some systems, knowing some information about quality and signals allows individuals to infer the quality of other individuals. One example of categorical recognition is badges of quality, where a signal can be used by others to make inferences about the quality of the individual. This is not the case in an individualized recognition learning system, where specific individuals are recognized and associated with their quality (through past assessments of that same individual), and knowing something about the quality of one particular individual does not allow the animal to infer anything about the quality of other individuals. Under recognition learning, animals must infer the quality of the individuals they are assessing whereas under rule learning, animals learn the relationship between quality and signal, and through this rule, can assess quality. In both systems, animals assess others by attempting to infer their quality. Under recognition learning, individuals use past experience to categorize individuals and match them with their underlying quality; under rule-based learning, they infer the shape of the relationship between quality and signal. In rule-based learning, learning about the rule allows individuals to infer quality of others based on signal, even without assessing that individual's quality through interactions or observation. In contrast, recognition-based learning does not allow individuals to infer quality to other individuals, or to other categories, with which they do not have experience. 

% HOW TO SAMPLE / ASSESS QUALITY (maybe move to model description??)
...
% Previous work on comparing costs/benefits/tradeoffs between assessment systems
...
% When thinking about the tradeoff between two types of recognition-based assessment methods, individual recognition and badge categorization, Sheehan and Bergman~\citep{sheehan2016evotradeoff} predicted that group size, the stability of the social group, and the stability of the quality signal over time should all affect how well animals using recognition-based systems can learn about their peers. Other work on rules of thumb have focused more on the stability of the signal and the likelihood that cheaters will exploit the assessment system by violating the signal/quality relationship. [ADD MORE DETAILS??]
