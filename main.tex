...
% birds reviewed in \cite{Santos:2011ly}
...
% Bimodal distributions of badges should be favored if there is stronger competition between dominant animals than between dominant and subdordinate animals or if the dominant animals in a group have significantly higher reproductive success \cite{Ripoll:2004vn}.
