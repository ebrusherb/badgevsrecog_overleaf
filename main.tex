...
We consider two different methods of learning: individual recognition and badges. An animal using individual recognition can identify each of its group mates as a particular individual. An animal using the badge system only recognizes animals based on the signals they display in a categorical fashion. 
...
\label{parameters}
% can we change the high/lower correlation lines to be red?, or actually, for clarity, maybe have 3 items in legend (indiv, badge 0.5, badge 0.9)
%and this is without observation, right?
\end{figure}
...
\label{comparison}
%these are looking really squished, maybe we could rotate to have 2 cols, 4 rows instead? Then the plots could be squared up so they won't look so squished..?
\end{figure}
