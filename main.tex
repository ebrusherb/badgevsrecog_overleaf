...
%In all of our analyses, we use the following parameters: standard deviation of noise in estimating quality $\sigma_\xi=0.05$, standard deviation of quality values $\sigma_\text{q}=0.5$, and the total number of interactions $T=30,000$. As shown in Figure \ref{learning_curves}, using $T=30,000$ interactions ensures that the average error has reached its equilibrium level.
